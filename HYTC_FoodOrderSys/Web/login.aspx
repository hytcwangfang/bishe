<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Web._default" %>
...
<head id="Head1" runat="server">
	...
	<title>中华外卖登录页面</title>
</head>
<body>
	<div class="log_top">
		<div class="log_logo">
			<a href="#"><img src="images_tool/logo.png" /></a>
		</div>
	</div>
	<div class="log_content">
		<div class="log_login">
			<div class="log_login_left"><img src="images_tool/loginimg1.gif" /></div>
