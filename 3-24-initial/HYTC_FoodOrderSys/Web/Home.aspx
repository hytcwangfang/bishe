...
<body>
	...
	<div class="topArea">
		<div class="top">
			<span class="welcome" runat="server" id="Welcome">欢迎来到 美食外卖！请{ <span class="login">登录</span> } <a href="sign.aspx" class="sign"> 免费注册</a></span>
			<ul class="shopInfor">
				<li class="shop">
                    <a href="UserNav.aspx">
	...
	<div class="contentArea">
		<div class="adverA">
			<div class="pptarea">
				<div class="curImg" curchoice="1">
					<div class="imgsA">
						<img class="nextImg" src="images_data/g2.jpg" />
						<img class="nextImg" src="images_data/g3.jpg" />
						<img class="nextImg" src="images_data/g5.jpg" />
					</div>
				</div>
				<ul class="pptchoice">
        ...
        <asp:Repeater runat="server" ID="refoodclassname">
            <HeaderTemplate><ul class="imgarea"></HeaderTemplate>
            <ItemTemplate>
                <li>
                    <a href="FoodMenu.aspx?foodclassid=<%# Eval("classid") %>" target="_blank">
                        <img src="<%# Eval("classimg") %>" />
                        <span class="meng"><%# Eval("classname") %></span>
                    </a>
                </li>
            </ItemTemplate>
        ...
        <div id="top5">
		    <div id="top5up">
			    <a href="" class="top5upspecial1">图片赏析</a>
