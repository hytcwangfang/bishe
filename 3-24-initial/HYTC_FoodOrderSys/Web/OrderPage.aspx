    ...
    <form id="form1" runat="server">
        ...
        <div class="alb_conA" id="createorder">
            ...
            <ul class="alb_con reminheight">
                ...
                <asp:Repeater runat="server" ID="readdrlist">
                    <ItemTemplate>
                        <li class="order_row">
                            <ul class="order_fill">
                                <li class="addr_sizesm abbrcon redcolor"><%# Eval("receivename")%></li>
                                <li class="addr_sizesm abbrcon"><%# Eval("userphone")%></li>
                                <li class="addr_sizelg abbrcon redStyle"><%# Eval("addrdes")%></li>
                                <li class="addr_sizesm">
                                    <span class="order_action bluecolor">修改</span>
                                    <span class="order_action redStyle"><input type="checkbox" isdefault="<%# Eval("IsDefault") %>" />选中</span>
                                </li>
                            </ul>
                        </li>
                    </ItemTemplate>
            ...
            <ul class="alb_con reminheight">
                ...
                <asp:Repeater runat="server" ID="reshoplist">
                    <ItemTemplate>
                        <li class="order_row">
                            <ul class="order_fill">
                                <li class="order_sizelg redcolor"><a href="FoodDetail.aspx" target="_blank"><%# Eval("foodname") %></a></li>
                                <li class="order_sizejust"><%# Eval("foodcount") %></li>
                                <li class="order_sizejust">￥<%# Eval("foodprice") %></li>
                                <li class="order_sizejust redStyle">￥<%# Eval("multiprice") %></li>
                ...
                <li class="order_row">
                    <p class="order_title">订单金额：￥<% =sumprice %>.00</p>
                </li>
                <li class="order_row">
                    <p class="order_title">配送费用：￥0.00</p>
                </li>
                <li class="order_row">
                    <p class="order_title redcolor">需要付款：￥<% =sumprice %>.00</p>
                </li>
            </ul>
